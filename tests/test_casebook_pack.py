"""Regression checks for the thread-ops-schedule-guard casebook."""
...
from casebook.harness import assert_expected, thread_ops_schedule_guard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(thread_ops_schedule_guard_summary(), assert_expected())
